...
//
//import static org.apertereports.model.ReportOrder.Status.FAILED;
//import static org.apertereports.model.ReportOrder.Status.PROCESSING;
//import static org.apertereports.model.ReportOrder.Status.SUCCEEDED;
//
...
//
///**
// * Displays cyclic report order details (i.e. description, format, cron
// * expression). Each cyclic report can be configured to use a different set of
// * report parameters. These are configurable from this panel.
// */
...
//				org.apertereports.dao.ReportTemplateDAO.fetchAllReports(true));
...
//			ReportOrder rep = cyclicReport.getProcessedOrder() != null ? cyclicReport.getProcessedOrder()
//					: cyclicReport.getReportOrder();
...
//			outputFormatSelect.setValue(cyclicReport.getOutputFormat() != null ? ReportType.valueOf(cyclicReport
//					.getOutputFormat()) : "");
//		}
//	}
//
//	/**
//	 * Initializes the fields of the report details. An instance of
//	 * {@link CronValidator} is added to a text field responsible for displaying
//	 * the cron expression.
//	 */
...
//
//	/**
//	 * Initializes a selected report parameters. The parameters are show in a
//	 * {@link ReportParametersComponent}. The buttons are available only when a
//	 * report template has been selected.
//	 */
...
//						.addComponent(new TPTLazyLoadingLayout(
//								parametersComponent = new ReportParametersComponent(
//										report.getContent() != null ? report.getContent() : "", report.getId(),
//										XmlReportConfigLoader.getInstance().xmlAsParameters(
//												cyclicReport.getParametersXml() != null ? cyclicReport
//														.getParametersXml() : ""), false, true, false), true));
//			} catch (Exception e) {
...
//
//	/**
//	 * Adds listeners to buttons and wraps them in a
//	 * {@link SimpleHorizontalLayout}.
//	 * 
...
//						byte[] data = reportMaster.generateAndExportReport(reportType.name(),
...
//				&& StringUtils.isNotEmpty((String) descriptionField.getValue())
//				&& outputFormatSelect.getValue() != null && StringUtils.isNotEmpty((String) emailField.getValue())
//				&& validateParameters();
//	}
//
//	/**
//	 * Updates the report data. This should be called after a positive
//	 * validation.
//	 */
...
//		cyclicReport.setParametersXml(XmlReportConfigLoader.getInstance().mapAsXml(
//				parametersComponent.collectParametersValues()));
...
//
//	/**
//	 * Invoked after the form was validated successfully and the cyclic report
//	 * config was updated.
//	 */
