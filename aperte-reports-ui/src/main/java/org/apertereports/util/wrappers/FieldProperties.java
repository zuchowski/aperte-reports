...
/**
 * A bean class that represents a single report parameter defined in Jasper's
 * JRXML.
 */
public class FieldProperties {
	 ...
	 * </pre>
	 * 
	 * The string is split by a semicolon. The first part should be a JNDI name
	 * of the datasource, while the second - the SQL query to use.
	 */
	private String dictQuery;
	/**
	 * A static dictionary list items. For example this parameter could look
	 * like this:
	 * <p/>
	 * 
	 * <pre>
	...
	/**
	 * Error shown on validation error of a special control code. Used along
	 * with the {@link ScriptEngine}.
	 */
