...
//        TODO: use property set underneath the form
	...
	/**
	 * Builds a new field container carrying the generated Vaadin field with
	 * all its properties. Returns
	 * <code>null</code> on {@link BuildingFailedException} which may occur
...
//            return null;
	...
	/**
	 * Invokes a special script query using the invokable field property. If
	 * the invokable property is not present a default list is returned.
	 *
	 * @param fieldProperties Field properties
	...
	/**
	 * Retrieves the value from a report parameter properties. If the input
	 * type cannot be determined a default value is returned.
	 *
	...
	/**
	 * Populates Vaadin field properties based on report parameters taken
	 * from JRXML.
	 *
	 * @param param Report parameter
	...
	/**
	 * Attaches the component in the application. The reason the
	 * initialization of the view is here is that we need to access user's
	 * login which may be unavailable at th = nulle time of creation of the
	 * component.
	 */
	@Override
	public void attach() {
