...
public class VriesConfigurationDAO {
    public static Collection<ConfigurationEntry> loadAll() {
        return new pl.net.bluesoft.rnd.apertereports.dao.utils.WHS<Collection<ConfigurationEntry>>() {
            @Override
    ...
    public static List<ConfigurationEntry> findById(final String... key) {
        return new pl.net.bluesoft.rnd.apertereports.dao.utils.WHS<List<ConfigurationEntry>>(false) {
            @Override
