...
import pl.net.bluesoft.rnd.vries.mdb.CyclicOrderResponseProcessor;
...
public class CyclicOrderResponseProcessorTest {
    ...
    /**
     * Test method for
     * {@link pl.net.bluesoft.rnd.vries.mdb.CyclicOrderResponseProcessor#onMessage(javax.jms.Message)}
     * .
     *
     * @throws Exception
     */
