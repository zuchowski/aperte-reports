...
public class ReportOrderPusherTest {
    ...
    /**
     * Test method for
     * {@link pl.net.bluesoft.rnd.vries.ReportOrderPusher#buildNewOrder(pl.net.bluesoft.rnd.vries.data.ReportTemplate, java.util.Map, java.lang.String, java.lang.String, String, String)}
     * .
     *
     * @throws Exception
     */
