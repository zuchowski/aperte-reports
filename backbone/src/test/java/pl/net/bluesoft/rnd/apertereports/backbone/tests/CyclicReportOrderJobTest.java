...
public class CyclicReportOrderJobTest {
    ...
    public final void testProcessOrder() throws SecurityException, NoSuchMethodException, VriesException,
        ...
        try {
            ...
            CyclicReportOrder cyclicReportOrder1 = pl.net.bluesoft.rnd.apertereports.dao.CyclicReportOrderDAO.fetchCyclicReportOrder(croId);
            ...
            try {
                pl.net.bluesoft.rnd.apertereports.dao.CyclicReportOrderDAO.removeCyclicReportOrder(cro);
            }
            finally {
                try {
                    pl.net.bluesoft.rnd.apertereports.dao.ReportOrderDAO.removeReportOrder(rep1);
                }
                finally {
                    pl.net.bluesoft.rnd.apertereports.dao.ReportTemplateDAO.remove(reportTemplate1);
                }
            }
        }
    }
