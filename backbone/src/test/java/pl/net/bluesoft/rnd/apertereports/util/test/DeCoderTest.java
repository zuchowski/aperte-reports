 ...
 *
 */
package pl.net.bluesoft.rnd.apertereports.util.test;
...
public class DeCoderTest {
    ...
    /**
     * Test method for
     * {@link pl.net.bluesoft.rnd.apertereports.util.DeCoder#baosToEncodedString(java.io.ByteArrayOutputStream)}
     * {@link pl.net.bluesoft.rnd.apertereports.util.DeCoder#decodeStringToBais(char[])}
     * .
     *
     * @throws IOException
     */
    ...
    /**
     * Test method for
     * {@link pl.net.bluesoft.rnd.apertereports.util.DeCoder#serializeParameters(java.util.Map)}
     * {@link pl.net.bluesoft.rnd.apertereports.util.DeCoder#deserializeParameters(char[])}
     * .
     */
    @Test
