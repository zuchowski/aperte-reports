...
/**
 * Represents a persistent report generation order. The data should be kept in <code>vries_report_order</code> table in <code>public</code> schema.
 */
@Entity
@Table(schema = "public", name = "vries_report_order")
public class ReportOrder {
    ...
    /**
     * Report status as defined in enum pl.net.bluesoft.rnd.vries.data.ReportOrder.Status
     * <dl>
     * <dt>0</dt>
     * <dd>new</dd>
     * <dt>1</dt>
