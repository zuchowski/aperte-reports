...
public class EmailProcessor implements ConfigurationConstants {
     ...
     * The configuration should contain keys specified by {@link ConfigurationConstants}.
     */
    ...
    public synchronized void processEmail(final ReportOrder reportOrder) throws Exception {
        ...
        String contentType = Constants.ReportMimeType.valueOf(reportOrder.getOutputFormat()).mimeType();
    ...
    private byte[] getReportContent(ReportOrder reportOrder) throws Exception {
        ByteArrayInputStream bais = new ByteArrayInputStream(Base64.decodeBase64(String.valueOf(reportOrder
