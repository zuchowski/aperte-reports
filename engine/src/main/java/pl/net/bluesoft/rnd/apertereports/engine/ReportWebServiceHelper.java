...
import pl.net.bluesoft.rnd.apertereports.common.xml.ws.ReportExporterParameter;
import pl.net.bluesoft.rnd.apertereports.common.ReportConstants.ErrorCodes;
import pl.net.bluesoft.rnd.apertereports.common.ReportConstants.Parameter;
...
public class ReportWebServiceHelper {
    ...
    private Map<String, Object> getReportParameters(ReportData reportData) throws ReportException {
        ...
        try {
            for (pl.net.bluesoft.rnd.apertereports.common.xml.ws.ReportParameter param : reportData.getReportParameters()) {
