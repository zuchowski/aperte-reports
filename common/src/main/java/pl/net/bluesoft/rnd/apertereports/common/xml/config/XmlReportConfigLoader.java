package pl.net.bluesoft.rnd.apertereports.common.xml.config;

import pl.net.bluesoft.rnd.apertereports.common.xml.XmlHelper;
...
public class XmlReportConfigLoader extends XmlHelper {
     ...
     * The key of the map is the parameter's name. The value is {@link pl.net.bluesoft.rnd.apertereports.common.xml.config.ReportConfigParameter#getValue()}.
