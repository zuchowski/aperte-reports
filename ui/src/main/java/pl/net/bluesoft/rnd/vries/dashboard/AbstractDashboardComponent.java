...
import static pl.net.bluesoft.rnd.vries.util.DashboardPreferences.PREFERENCE_REPORT_CONFIGS_KEY;
import static pl.net.bluesoft.rnd.vries.util.DashboardPreferences.PREFERENCE_TEMPLATE_KEY;
...
public abstract class AbstractDashboardComponent extends CustomComponent {
     ...
     * {@link pl.net.bluesoft.rnd.vries.util.DashboardPreferences#PREFERENCE_TEMPLATE_KEY}.
     ...
     * {@link pl.net.bluesoft.rnd.vries.util.DashboardPreferences#PREFERENCE_TEMPLATE_KEY} key
