...
import pl.net.bluesoft.rnd.vries.dashboard.html.ReportStreamReceiver;
...
public class VriesInvokerComponent extends CustomComponent {
    ...
    private void buildMainLayout() {
        ...
        generateReportButton = new Button(TM.get("invoker.intro.generate"));
    ...
    private void fillReportList() {
        reportSelect = new Select(TM.get("invoker.intro.select_report"));
        ...
        refreshButton = new Button(TM.get("dashboard.view.refresh"));
    ...
    private void initShowReportParamsButton() {
        generateReportButton.addListener(new Button.ClickListener() {
            ...
            public void buttonClick(ClickEvent event) {
                if (report != null) {
                    reportParamWindow = new ReportParamWindow(report, TM.get("invoker.window.title"), receiver);
