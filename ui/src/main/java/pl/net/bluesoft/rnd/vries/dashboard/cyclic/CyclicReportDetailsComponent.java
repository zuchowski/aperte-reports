...
import pl.net.bluesoft.rnd.vries.util.validators.CronValidator;
import pl.net.bluesoft.rnd.vries.xml.XmlHelper;

import javax.xml.bind.JAXBException;
import java.util.*;

import static pl.net.bluesoft.rnd.vries.data.ReportOrder.Status.FAILED;
import static pl.net.bluesoft.rnd.vries.data.ReportOrder.Status.PROCESSING;
import static pl.net.bluesoft.rnd.vries.data.ReportOrder.Status.SUCCEEDED;
